...
function elegirTema() {
    let validacion = confirm("¿Desea usar a modo oscuro?")
    if (validacion){
        sitio.classList.add("dark")
        btnTema.innerHTML = "Cambiar a modo claro 🌞"
        //}
        //document.querySelector("header").classList.add("dark")
        //document.querySelector(".info").classList.add("dark")
        //document.querySelector(".noticias").classList.add("dark")
        //document.querySelector("footer").classList.add("dark")
        //let articulos = document.querySelectorAll(".noticias article")
        //articulos.forEach(item => item.classList.add("dark"))
