...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        userRepository.save(new AppUser("UsuarioAdmin", "UsuarioAdmin", "admin@email.com", hashedPassword, AppUserRole.ADMIN));
        userRepository.save(new AppUser("UsuarioUser", "UsuarioUser", "user@email.com", hashedPasswordB, AppUserRole.USER));
    }
}
